...
Die \emph{Modulo} Operation ist eine Division zweier Zahlen, wobei das Resultat der Rest dieser Division ist. In mathematischer Notation schreibt man typischerweise $a \, mod \, b$ um zu sagen, "dividiere $a$ durch $b$ und 'nimm den Rest'".
