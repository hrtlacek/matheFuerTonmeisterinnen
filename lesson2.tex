...
\item Sie finden folgende funktion vor $x(t) = u(t-3) \cdot sin(t) \cdot \frac{1}{t-3}$. Plotten / Skizzieren sie diese. Könnten Sie sie zeitlich 'umdrehen' (spiegelung um die ordinate).
