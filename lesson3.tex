...
Wohl eine der wichtigsten Gleichungen für die Audio Technik ist die \index{Eulersche Formel}:
...
Aus Gleichung \ref{eq:euler} und der Polaren Darstellung leitet sich die '\index{Eulersche Darstellung}' oder auch '\index{Exponentialform}' für komplexe Zahlen ab:
...
Gegeben $z_1 = a + bi$ wir die zahl $z_2 = a - bi = \overline{z_1}$ als \index{konjugiert komplex} bezeichnet. Oder in Exponentialform:
