...
\item Gegeben $z_1 = \alpha e^{5i}$ und $z_2 = e^{it}$ berechnen Sie $z_3 = z_1 \cdot z2$. Stellen das ergebnis in \textbf{polarer Darstellung} dar.

\item Berechnen Sie imaginärteil und realteil von: $e^i$, $e^{i\pi}$, $e^{\pi}$.
