...
\section*{Errata}
Bitte alle Fehler gerne entweder an \texttt{ptrk.lechner@gmail.com} melden oder direkt einen \emph{issue} auf github öffnen oder sehr gerne selbst ändern und einen \emph{pull request} machen.
